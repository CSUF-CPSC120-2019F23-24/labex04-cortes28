...
int main()
{
  ...
  char my_char3 = 'z';
  my_char3 = my_char3 + 1 ;  //It is no longer aplhabetic because we assigned a value to my_char3.
  ...
  //The value of my_short2 differs from my_int2 because the values of short and int differ from one another
  //and  short overflows meanwhile the value of int will convert it to negative.
